...
perl -i -0777 -pe 's/^plugins=\([^)]*\)/plugins=(colored-man-pages command-not-found extract sudo docker git pip python virtualenv archlinux systemd common-aliases docker-compose jsontools urltools dotenv aliases alias-finder history rsync tmux fd ripgrep)/m' ~/.zshrc
