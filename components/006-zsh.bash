...
perl -i -0777 -pe 's/^plugins=\([^)]*\)/plugins=(colored-man-pages colorize command-not-found extract sudo docker git pip python virtualenv archlinux systemd cargo common-aliases docker-compose jsontools rust urltools dotenv aliases alias-finder aws golang helm history kubectl rsync)/m' ~/.zshrc
